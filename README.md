...
### Block(byte[,] матрица, int h, int v)

Создает блок на основе заданной матрицы, её ширины H и высоты V
...
Возвращае ширину блока h

### int GetV()

Возвращает высоту блока v
...
h = 2, Hmax = 4, ширина увеличиться в 2 раза.
